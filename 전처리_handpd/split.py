...
실행
    python 전처리_handpd/split.py --npz 전처리_handpd/windows_2s.npz \
        --data-root 전처리_handpd
"""
import argparse
import glob
import os
...
def main():
    ...
    ap.add_argument("--npz", default="전처리_handpd/windows_2s.npz")
    ap.add_argument("--data-root", default="전처리_handpd",
